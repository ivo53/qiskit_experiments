...
pulse_type = "lorentz"
date = "2022-06-21" # "2022-06-17" #
area = "pi"
params = ["width", "duration"]
ctrl_idx = 0
ctrl_param = params[ctrl_idx]
vary_param = params[~ctrl_idx]
cutoff = 0.2
center_freq = 4.97169
...
fig.suptitle(f"{pulse_type.capitalize()}-shaped Pulses of Area {area.capitalize()} at Different Truncation Heights by Varying Pulse {vary_param.capitalize()}",fontsize=20)

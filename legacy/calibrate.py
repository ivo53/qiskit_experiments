...
duration = 1.
min_amplitude, max_amplitude = 0.001, 0.5
num_exp = 100
...
for amp in amplitudes:
    ...
    G = 1000
    lor_t_dt = np.arange(lor_dur_dt)
    lor_amps = 1000 * amp * G / ((lor_t_dt - lor_dur_dt / 2) ** 2 + G ** 2) + lor_B
    lor = pulse_lib.Waveform(samples=lor_amps, name="lorentzian pulse")
    ...
    pi_schedule += Play(pulses[pulse_type_area], drive_chan)

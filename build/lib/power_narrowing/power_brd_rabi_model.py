...
where_is_peaks = [10, 28, 47, 66, 84]

tr_prob = tr_prob[where_is_peaks]
amp = amp[where_is_peaks]
...
for i, t in zip(np.arange(len(amp)), tr_prob):
...
ax.set_xticks(np.arange(-12, 12+0.001, 3))

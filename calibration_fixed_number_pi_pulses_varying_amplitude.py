...
calib_dir = os.path.join(file_dir, "plots", "many_pi_pulses_amp_vary")
...
plt.savefig(os.path.join(save_dir, date.strftime("%H%M%S") + f"_{num_dd_blocks}_pi_pulses_duration-{pi_pulse_duration}_amp_variation.png"))
plt.show()

...
class ParametricPulseShapes(Enum):
    ...
    lorentzian = library.Lorentzian
    lorentzian_fragment = library.LorentzianFragment
    lorentzian_square = library.LorentzianSquare
    lorentzian_cube = library.LorentzianCube
    sech = library.Sech
    sech_square = library.SechSquare
    demkov = library.Demkov
    sine = library.Sine
    sine_square = library.SineSquare
    sine_cube = library.SineCube
    sine_fourth_power = library.SineFourthPower
    sine_fifth_power = library.SineFifthPower
